# CipherEdge backtest report - `sensitivity-notional-cap_2026-09-21_16-39-51Z_cap33`

Generated: 2026-09-21T16:39:52.563Z  ·  config hash: `d57f92765ac46fc1`  ·  Node v24.19.0
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| total | 10000 | 9058.34 | -9.417% | 10.337% | -6.513 | -2.86 | 6.16% | 8599 |
| in-sample | 10000 | 9259.53 | -7.405% | 8.002% | -8.071 | -3.482 | 5.81% | 5732 |
| out-of-sample | 9259.53 | 9058.34 | -2.173% | 3.418% | -3.91 | -1.764 | 6.81% | 2867 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| total | 100 | 35% | -941.66 | 0.401 | -0.512 | -9.42 | 347m | 90/10 | 10/90 |
| in-sample | 64 | 29.7% | -740.47 | 0.299 | -0.636 | -11.57 | 363m | 58/6 | 6/58 |
| out-of-sample | 36 | 44.4% | -201.18 | 0.609 | -0.293 | -5.59 | 319m | 32/4 | 4/32 |

Best R 1.682 · worst R -2.171 · median R -1.323 · avg win 17.99 · avg loss -24.18
...
| --- | --- | --- |
| fees | 622.79 | MODELLED (MODELLED - Bitget spot taker bps from config; no live fills exist) |
| slippage | 311.4 | MODELLED (MODELLED - flat adverse bps; not measured against an order book) - already embedded in fill prices, not deducted twice |
| funding | 21.49 | MODELLED (MODELLED - flat bps per 8h; spot rToken funding was not sampled) |
| observed execution costs | 0 | NONE - CipherEdge has never placed an order |

Turnover notional (OBSERVED): 622790.19 USDT over 90 days.
...
| avg actual risk per trade | 0.2082% |
| max actual risk per trade | 0.3219% |
...
| --- | --- | --- | --- | --- |
| BREAKOUT_RETEST | 90 | -869.12 | 34.4% | -0.504 |
| BEARISH_DIVERGENCE | 10 | -72.53 | 40% | -0.586 |

### By direction

| direction | trades | net PnL | win rate | avg R |
| --- | --- | --- | --- | --- |
| LONG | 90 | -869.12 | 34.4% | -0.504 |
| SHORT | 10 | -72.53 | 40% | -0.586 |

### By symbol

| symbol | trades | net PnL | win rate | avg R |
| --- | --- | --- | --- | --- |
| ETHUSDT | 34 | -419.76 | 23.5% | -0.681 |
| SOLUSDT | 28 | -342.64 | 35.7% | -0.623 |
| BTCUSDT | 38 | -179.26 | 44.7% | -0.279 |
...
Notional cap override: 33% (primary config default is 20%)
